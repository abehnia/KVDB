...
bool data_page_find_entry(const DataPage *data_page, const char *key, Record *record);
bool data_page_delete_entry(DataPage *data_page, const char *key);
bool data_page_insert_entry(DataPage *data_page, const Record *record, uint64_t hash);
